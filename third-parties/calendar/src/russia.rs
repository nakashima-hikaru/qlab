...
impl Russia {
    fn is_extra_holiday_settlement(&self, date: NaiveDate) -> bool {
        ...
        match y {
            ...
            2019 => matches!((m, d), (5, 2 | 3 | 9)),
            2020 => matches!((m, d), (3, 30 | 31) | (4, 1..=3)),
            _ => false,
        }
    }
    ...
    fn is_extra_holiday_exchange(&self, date: NaiveDate) -> bool {
        ...
        match y {
            ...
            2013 => matches!((m, d), (1, 1 | 2 | 3 | 4 | 7)),
            2014 => matches!((m, d), (1, 1 | 2 | 3 | 7)),
            2015 => matches!((m, d), (1, 1 | 2 | 7)),
            2016 => matches!((m, d), (1, 1 | 7 | 8) | (5, 2 | 3) | (6, 13) | (12, 30)),
            2017 => matches!((m, d), (1, 2) | (5, 8)),
            2018 => matches!((m, d), (1, 1 | 2 | 8) | (12, 31)),
            2019 => matches!((m, d), (1, 1 | 2 | 7) | (12, 31)),
            2020 => matches!((m, d), (1 | 7, 1) | (1, 2 | 7) | (2 | 6, 24)),
            _ => false,
        }
    }
    ...
    fn is_working_weekend(&self, date: NaiveDate) -> bool {
        let (d, _, m, y, _) = self.naive_date_to_dkmy(date);
        match y {
            2012 => matches!((m, d), (3, 11) | (4, 28) | (5, 5 | 12) | (6, 9)),
